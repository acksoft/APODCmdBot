...
import { ApodMockCommandHandler } from "../apodMockCommandHandler";
import { ApodLiveCommandHandler } from "../apodLiveCommandHandler";
...
export const commandApp = new ConversationBot({
  ...
  command: {
    ...
    commands: [
      ...
      new ApodMockCommandHandler(),
      new ApodLiveCommandHandler(),
    ],
  },
});
